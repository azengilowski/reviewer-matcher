...
/**
 * Peerfect Match mark: the wordmark's script "P" over a double check —
 * peer-reviewed, twice — on the brand gradient.
 */
export function Logo({ size = 22 }: { size?: number }) {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(200 200) scale(1.18) translate(-256 -256)">
        <path d={PACIFICO_P} fill="#fff" />
      </g>
      {/* Double check: reviewed twice. Thin strokes and a clear gap so they
          read as two ticks, never a "w". */}
      <g fill="none" stroke="#fff" strokeWidth="24" strokeLinecap="round" strokeLinejoin="round">
        <path d="M 252 406 L 284 438 L 330 382" />
        <path d="M 360 406 L 392 438 L 438 382" />
      </g>
    </svg>
  )
}
